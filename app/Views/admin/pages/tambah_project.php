...
<div class="container py-4 fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-3">
        <div>
            ...
            <p class="text-muted mb-0">Tambah project baru dengan detail lengkap</p>
        </div>
    ...
    <div class="card shadow-sm border-0 rounded-3">
        <div class="card-body p-4">
            <form action="<?= site_url('admin/pages/project/tambah') ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>

                <!-- Upload Modern -->
                <div class="mb-4">
                    <label for="gambar" class="form-label fw-semibold">Upload Gambar Project</label>
                ...
                <div class="form-floating mb-4">
                    <textarea class="form-control <?= session('errors.description') ? 'is-invalid' : '' ?>"
                        ...
                        name="description"
                        style="height: 120px;"
                        placeholder="Masukan deskripsi project..." required><?= old('description') ?></textarea>
                ...
                <div class="text-end">
                    <button type="submit" class="btn btn-gradient px-3 py-2 rounded-pill">
                        <i class="fa-solid fa-file-circle-plus"></i> Tambah Project
                    </button>
                </div>
            </form>
        </div>
