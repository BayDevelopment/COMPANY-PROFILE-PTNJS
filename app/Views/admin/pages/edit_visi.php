...
<div class="container py-4 fade-in">
    ...
    <div class="d-flex justify-content-between align-items-center mt-4 mb-4">
        <div>
            <h1 class="fw-bold text-warning">Edit Visi</h1>
            <p class="text-muted mb-0">Perbarui data visi perusahaan dengan benar dan jelas</p>
        </div>
    ...
    <div class="card shadow-lg border-0 rounded-4">
        <div class="card-body p-4">
            <form action="<?= site_url('admin/pages/about/visimisi/edit-visi/') . esc($d_visi['id_visi']) ?>" method="POST" enctype="multipart/form-data">
                <?= csrf_field() ?>
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control form-control-lg rounded-3 shadow-sm"
                        ...
                        id="visi"
                        rows="5"
                        placeholder="Masukkan visi perusahaan dengan jelas..."
                        required><?= esc($d_visi['visi']) ?></textarea>
